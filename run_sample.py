...
if __name__ == '__main__':
    ...
    parser.add_argument("--ir_label_out_dir", default="/home/maruf/AdvCAM/result/ir_label", type=str)
    ...
    if args.train_cam_pass is True:
        import step.train_cam_bin_noise
        # import step.train_cam_noisy # additional for robustness
#         import step.train_cam_beit
        # import step.train_cam_strong_augment

        timer = pyutils.Timer('step.train_cam:')
        step.train_cam_bin_noise.run(args)
        # step.train_cam_noisy.run(args)
#         step.train_cam_beit.run(args)
        # step.train_cam_strong_augment.run(args)
